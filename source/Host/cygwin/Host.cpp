...
#include "Plugins/Process/Cygwin/ProcFileReader.h"
...
static bool ReadProcPseudoFileStat(lldb::pid_t pid,
  ...
  lldb::DataBufferSP buf_sp =
      process_cygwin::ProcFileReader::ReadIntoDataBuffer(pid, "stat");
...
static void GetLinuxProcessUserAndGroup(lldb::pid_t pid,
  ...
  // fields.
  lldb::DataBufferSP buf_sp =
      process_cygwin::ProcFileReader::ReadIntoDataBuffer(pid, "status");
...
static bool GetProcessAndStatInfo(lldb::pid_t pid,
...
#if 0
  buf_sp = process_cygwin::ProcFileReader::ReadIntoDataBuffer(pid, "environ");
  ...
  buf_sp = process_cygwin::ProcFileReader::ReadIntoDataBuffer(pid, "cmdline");
  ...
  if (cmd) {
    ...
    char *end_buf = cmd + buf_sp->GetByteSize();
