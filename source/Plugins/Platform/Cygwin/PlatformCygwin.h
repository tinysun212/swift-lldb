...
#ifndef liblldb_PlatformCygwin_h_
#define liblldb_PlatformCygwin_h_
...
namespace platform_cygwin {

class PlatformCygwin : public Platform {
public:
  PlatformCygwin(bool is_host);

  ~PlatformCygwin() override;
  ...
  // Cygwin processes can not be launched by spawning and attaching.
...
private:
  DISALLOW_COPY_AND_ASSIGN(PlatformCygwin);
};

} // namespace platform_cygwin
} // namespace lldb_private

#endif // liblldb_PlatformCygwin_h_
